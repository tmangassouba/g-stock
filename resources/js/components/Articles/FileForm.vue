...
<!-- :disabled="file == null" -->
            <div class="">
                <b-button size="is-small" type="is-info" native-type="submit" :loading="uploadingFile" >Télécharger</b-button>
    ...
    export default {
        ...
        methods: {
            ...
            uploadFile() {
                ...
                Inertia.post('/articles/' + this.article.code + '/upload-files', data)
                .then(() => {
                    if (this.$page.flash.message != null ) {
                        // this.$inertia.visit('/articles/' + this.article.code)
                        this.file = null
